...
export function apply(ctx) {
  ...
  const writeToDisk = async () => {
    ...
    // mid-write must never leave a truncated memory.json behind, because the
    // reader refuses to touch a file it cannot parse — half-written JSON
    // would wedge every future boot until hand-repaired.
